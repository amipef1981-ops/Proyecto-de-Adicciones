...
class Principal(QMainWindow):
    ...
    def crear_pestana_test(self):
        ...
        self.respuestas = [0] * len(self.preguntas)
    ...
    def crear_pestana_resultados(self):
        ...
        self.bar = pg.BarGraphItem(x=np.arange(1, len(self.preguntas)+1), height=self.respuestas, width=0.6, brush='b')
        self.plot.addItem(self.bar)
        self.plot.setXRange(1, len(self.preguntas)+1)
    ...
    def seleccionar_respuesta(self, btn):
        ...
        index = self.btn_respuestas.index(btn)
        self.respuestas[self.index_pregunta] = index + 1
    ...
    def mostrar_resultados(self):
        # Actualizar el gráfico de barras con las respuestas
